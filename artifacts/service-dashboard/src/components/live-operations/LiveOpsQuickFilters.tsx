...
const QUICK = [
  {
    id: "wip",
    label: "Only WORK_IN_PROGRESS",
    patch: { ticketStatus: "WORK_IN_PROGRESS" },
    active: (f: FilterBarState) =>
      f.ticketStatus === "WORK_IN_PROGRESS" || f.ticketStatus === "WIP",
  },
  {
    id: "mrf",
    label: "Only MRF",
    patch: { ticketStatus: "MRF" },
    active: (f: FilterBarState) => f.ticketStatus === "MRF",
  },
  {
    id: "assigned",
    label: "Only ASSIGNED",
    patch: { ticketStatus: "ASSIGNED" },
    active: (f: FilterBarState) => f.ticketStatus === "ASSIGNED",
  },
